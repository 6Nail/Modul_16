...
namespace task1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (FileStream stream = new FileStream(@"C:/Users/АкчуринНа/source/repos/Modul_16/README.md", FileMode.OpenOrCreate))
            {
            ...
            {
                Console.WriteLine(item.Key + "/t/t" + item.Value);
            }
            Console.ReadLine();
        }
    }
